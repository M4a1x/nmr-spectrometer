...
In 1896 the Dutch physicist Pieter Zeemann discovered that spectral lines -- e.g. those of a mercury vapour lamp -- split up in the presence of a magnetic field \sidecite{zeemanInfluenceMagnetismNature1896}.
