...
To tackle this problem, the presented work focuses on lowering the entry barrier to magnetic resonance research, specifically \acrfull{nmr}. Consequently, we developed a low-cost easy-to-use easy-to-build low-field \acrshort{nmr} spectrometer. The detailed, hands-on documentation includes specifications, simulations, full hardware descriptions, CAD designs Python control code and reproducible measurement results\sidenote{The full documentation including the source codes is currently available at the \href{https://github.com/M4a1x/nmr-spectrometer}{official Git repository} (\url{https://github.com/M4a1x/nmr-spectrometer})}.

% Preview of the paper to prepare for structure
First, the general concept of an \acrshort{nmr} spectrometer is briefly introduced in \refch{concepts}, which is then expanded upon in detail when describing the individual parts of the built spectrometer in \refch{methods}. Having delved into all the parts of an \acrshort{nmr} spectrometer \refch{complete} describes the usage of the whole system. \refch{results} then presents the measurement results obtained with the built spectrometer. Finally, \refch{conclusion} ends with a conclusion and the high-level achievements of this work together with an outlook of still-to-be-done tasks.
