...
\begin{figure}[hbt]
    ...
    \caption{\captiontitle{VNA \(S_{11}\) and \(S_{21}\) measurement.} An \(S_{11}\) of \qty{-14.47}{\deci\bel} and a \(S_21\) of \qty{23.21}{\deci\bel} was measured at \qty{25}{\mega\hertz} using a nanoVNA-H4.}
    \labfig{preamp-vna}
\end{figure}
