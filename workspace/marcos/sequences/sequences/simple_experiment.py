...
def send_simple_pulse() -> None:
    ...
    exp = Experiment(lo_freq=(25.04, 25.04, 25), rx_lo=2, rx_t=sample_time_us)
    ...
    tx_rx_delay_us = 2  # must be >= tx_gate_post_us
    ...
    _, rx_axes = plt.subplots(3, 1, figsize=(12, 8), sharex="col", layout="constrained")
