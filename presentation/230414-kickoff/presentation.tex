...
\definecolor{ETHgrey}{HTML}{6F6F6F}     % for "background"
\definecolor{ETHpetrold}{HTML}{00596D}  % for dark teal
\definecolor{ETHbronzed}{HTML}{956013}  % for dark brown
\definecolor{ETHbronze}{HTML}{8E6713}   % for light brown
\definecolor{ETHgreen}{HTML}{627313}    % for light green

\setbeamercolor{normal text}{%
  fg=ETHpetrold,  % mDarkTeal,
  bg=black!2
}
\setbeamercolor{alerted text}{%
  fg=ETHbronze  % mLightBrown
}
\setbeamercolor{example text}{%
  fg=ETHgreen  % mLightGreen
}
